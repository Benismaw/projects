...
import fr.ensimag.ARM.Instructions.ARMBgt;
...
public class Greater extends AbstractOpIneq {
    ...
    protected void codeGenExprARM(DecacCompiler compiler, ARMGPRegister register) {
        ...
        String labelTrue = "gt_true_" + this.hashCode();
        String labelEnd = "gt_end_" + this.hashCode();
        ...
        prog.addInstruction(new ARMBgt(labelTrue));
