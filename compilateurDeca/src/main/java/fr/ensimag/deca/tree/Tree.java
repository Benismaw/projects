...
public abstract class Tree {
    ...
    /**
     * Charge le numéro de la ligne courante du fichier source dans le registre R1.
     */
    protected void loadErrorLine(DecacCompiler compiler) {
        int line = getLocation().getLine();
        compiler.addInstruction(new LOAD(
                new ImmediateInteger(line), Register.R1));
    }
}
