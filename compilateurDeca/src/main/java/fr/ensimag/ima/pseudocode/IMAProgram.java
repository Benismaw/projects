...
public class IMAProgram {
    ...
    /**
     * Retourne le nombre actuel d'instructions/lignes dans le programme.
     */
    public int size() {
        return lines.size();
    }
    ...
    /**
     * Ajoute une instruction à une position spécifique (index).
     */
    public void addInstructionAt(int index, Instruction i) {
